...
///     You can upload events only if the difference between the event date and the upload date is no more than fourteen days.</param>
...
{
	/// <summary>
	/// Event attributes serialized to JSON. Will be sent as the event_json parameter.
	/// </summary>
	public JsonNode? EventJson { get; init; }
}
